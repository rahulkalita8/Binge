...
Use of code formatters.	3	black configuration
Use of syntax checkers.	3	pylint
Use of code coverage		
other automated analysis tools		
test cases exist		test directory
test cases are routinely executed		GH Action
the files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up		CONTRIBUTING.md
